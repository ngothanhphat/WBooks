...
//    Biến lưu câu lệnh tạo bảng tài khoản
    private String SQLQuery = "CREATE TABLE "+ TABLE_ACCOUNT +" ( "+ID_ACCOUNT+" INTEGER PRIMARY KEY AUTOINCREMENT, "
            +NAME_ACCOUNT+" TEXT UNIQUE, "
            +PASSWORD+" TEXT, "
            +EMAIL+" TEXT, "
            + AUTHORIZE+" INTEGER) ";

//    Biến lưu câu lệnh tạo bảng sách
    private String SQLQuery1 = "CREATE TABLE "+ TABLE_BOOK +" ( "+ID_BOOK+" integer primary key AUTOINCREMENT, "
            +NAME_BOOK+" TEXT UNIQUE, "
            +CONTENT+" TEXT, "
            +IMAGE+" TEXT, "+ID_ACCOUNT+" INTEGER , FOREIGN KEY ( "+ ID_ACCOUNT +" ) REFERENCES "+
            TABLE_ACCOUNT+"("+ID_ACCOUNT+"))";

//    Insert dữ liệu vào bảng tài khoản
//    Phân quyền: 1 là admin, 2 là người dùng
    private String SQLQuery2 = "INSERT INTO account VAlUES (null,'admin','admin','admin@gmail.com',2)";
    private String SQLQuery3 = "INSERT INTO account VAlUES (null,'phat','phat','ntphat.20it10@vku.udn.vn',1)";
    private String SQLQuery4 = "INSERT INTO account VAlUES (null,'linh','linh','pvlinh.20it9@vku.udn.vn',1)";

//    Insert dữ liệu vào bảng sách
    private String SQLQuery5 = "INSERT INTO book VALUES (null,'Rùa và Thỏ','Phần 1:\n" +
            "\n" +
    ...
    private String SQLQuery6 = "INSERT INTO book VALUES (null,'Củ cải trắng','Mùa đông đã đến rồi trời lạnh buốt, Thỏ con không có gì để ăn cả. Thỏ con mặc áo vào rồi ra ngoài kiếm thức ăn. Nó đi mãi đi mãi cuối cùng cũng tìm được hai củ cải trắng. Thỏ con reo lên:\n" +
            "\n" +
    ...
    private String SQLQuery7 = "INSERT INTO book VALUES (null,'Dê đen và dê trắng','Dê đen và Dê trắng cùng sống trong một khu rừng. Hàng ngày, cả hai thường đến uống nước và tìm cái ăn ở trong khu rừng quen thuộc.\n" +
            "\n" +
...
//        Thực hiện các lệnh truy vấn không trả về kết quả
        db.execSQL(SQLQuery);
